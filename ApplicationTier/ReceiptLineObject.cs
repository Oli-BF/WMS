...
{
    /// <summary>
    ///     This class contains getters and setters for each column in the Receipt Lines table in the Database.
    /// 
    ...
    /// </summary>
    public class ReceiptLineObject
    {
        // Constructor
        public ReceiptLineObject()
        {
        }
