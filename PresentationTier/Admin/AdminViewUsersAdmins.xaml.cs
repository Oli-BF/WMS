...
namespace PresentationTier.Admin
{
    ...
    ///     requested. 
    /// 
    ///     The Data Grid being shown in this case is All User Admins.
    ///     
    ...
    /// </summary>
    public partial class AdminViewUsersAdmins : Page
    {
        ...
        {
            DataTable dataTable = businessLogicLayer.SelectAllUsersAdmins();
