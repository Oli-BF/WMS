...
namespace PresentationTier.Admin
{
    ...
    ///     
    ///     In this case it deletes a warehouse from the database.
    ///     
    ...
    /// </summary>
    public partial class AdminManageWarehousesDelete : Page
    {
        ...
        /// </summary>
        public AdminManageWarehousesDelete()
        {
            InitializeComponent();
        ...
        private void DeleteButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    warehouse = businessLogicLayer.DeleteCurrentWarehouse(warehouseNameInput.Text.ToLower());
                    MessageBox.Show(warehouseNameInput.Text + " has been deleted from the system.");
                }
            }
            catch (Exception ex)
            {
