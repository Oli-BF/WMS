...
namespace PresentationTier.Manager
{
    ...
    ///     requested. 
    /// 
    ///     The Data Grid being shown in this case is All Picks.
    ///     
    ...
    /// </summary>
    public partial class ManagerViewPicksAll : Page
    {
        ...
        {
            DataTable dataTable = businessLogicLayer.SelectAllPicks();
        ...
        private void Print_Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (printDialog.ShowDialog() == true)
            {
                ...
                MessageBox.Show("The on screen Picks have been sent to the printer.");
            }
        }
