...
namespace PresentationTier.Manager
{
    ...
    ///     requested. 
    /// 
    ///     The Data Grid being shown in this case is All Warehouses.
    ///     
    ...
    /// </summary>
    public partial class ManagerViewWarehousesAll : Page
    {
        ...
        /// </summary>
        public ManagerViewWarehousesAll()
        {
            InitializeComponent();
        ...
        {
            DataTable dataTable = businessLogicLayer.SelectAllWarehouses();
        ...
        private void dataGrid1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems != null && e.AddedItems.Count > 0)
            {
                ...
                int warehouse_id = int.Parse(row.Row["warehouse_id"].ToString());
                DataTable dataTable = businessLogicLayer.SelectAllStockMatchingWarehouseID(warehouse_id);
