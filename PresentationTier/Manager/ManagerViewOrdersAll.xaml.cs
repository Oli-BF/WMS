...
namespace PresentationTier.Manager
{
    ...
    ///     requested. 
    /// 
    ///     The Data Grid being shown in this case is All Orders.
    ///     
    ...
    /// </summary>
    public partial class ManagerViewOrdersAll : Page
    {
        ...
        {
            DataTable dataTable = businessLogicLayer.SelectAllOrders();
        ...
        private void dataGrid1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems != null && e.AddedItems.Count > 0)
            {
                ...
                int order_id = int.Parse(row.Row["order_id"].ToString());
                DataTable dataTable = businessLogicLayer.SelectOrderLinesMatchingOrderID(order_id);
