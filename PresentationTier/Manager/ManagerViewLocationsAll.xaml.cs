...
namespace PresentationTier.Manager
{
    ...
    /// </summary>
    public partial class ManagerViewLocationsAll : Page
    {
        ...
        /// </summary>
        public ManagerViewLocationsAll()
        {
            InitializeComponent();
        ...
        private void dataGrid1_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            if (e.AddedItems != null && e.AddedItems.Count > 0)
            {
                ...
                int location_id = int.Parse(row.Row["location_id"].ToString());
                DataTable dataTable = businessLogicLayer.SelectAllStockMatchingLocationID(location_id);
