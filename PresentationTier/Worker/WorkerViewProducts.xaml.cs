...
namespace PresentationTier.Worker
{
    ...
    ///     requested. 
    /// 
    ///     The Data Grid being shown in this case is All Products.
    ///     
    ...
    /// </summary>
    public partial class WorkerViewProducts : Page
    {
        ...
        {
            DataTable dataTable = businessLogicLayer.SelectAllProducts();
        ...
        {
            WorkerViewAccounts workerViewAccounts = new WorkerViewAccounts();
            this.NavigationService.Navigate(workerViewAccounts);
        }
