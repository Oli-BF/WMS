...
namespace PresentationTier.Worker
{
    ...
    /// </summary>
    public partial class WorkerViewReceiptLines : Page
    {
        ...
        {
            WorkerViewReceiptLines workerViewReceiptLines = new WorkerViewReceiptLines();
            this.NavigationService.Navigate(workerViewReceiptLines);
        }
